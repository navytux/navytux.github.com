...
// Copyright (C) 2018-2019 Kirill Smelkov <kirr@navytux.spb.ru>
//
...
(function (window, document) {
    ...
    function updateCardsSelection() {
        ...
        for (let li of cardList.children) {
            ...
            //console.log(li.dataset.cardNumber, qset.has( cardNo ))
            if (qset.has(cardNo)) {
    ...
    function showNextBigCard(idxDelta) {
        ...
        bigCard.textContent = cardv[cardsToPlay[cardsToPlayCurrent] - 1]
    }
